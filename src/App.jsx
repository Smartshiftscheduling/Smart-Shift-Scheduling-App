...
const App = () => {
  ...
  const styles = {
    appContainer: {
      ...
      color: '#ffffff',
      fontFamily: '"Times New Roman", Times, serif', // Elegant serif for that premium look
      padding: '20px'
    },
    logoSection: {
      textAlign: 'center',
    ...
    logoImg: {
      height: '100px',
      filter: 'drop-shadow(0 0 10px rgba(212, 175, 55, 0.3))' // Subtle gold glow
    },
    nav: {
      display: 'flex',
    ...
    goldCard: {
      ...
      border: '1px solid rgba(212, 175, 55, 0.15)', // Thin gold border
      borderRadius: '4px',
      padding: '40px',
